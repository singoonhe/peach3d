...
namespace Peach3D
{
    ...
    enum class LayoutAttrType {
        ...
        eBindCorner,        // <BindCorner>Center</BindCorner> or <BindCorner>0, 0.5</BindCorner>, widget bind pos type, 9 fixed position, default is (0, 0).
        eAutoPosition,      // <AutoPosition>Fix, Min</AutoPosition>        widget position will convert with this scale, default is fixed.
        ePosition,          // <Position>10, 30</Position>                  widget position, relative to BindCorner
        eAutoSize,          // <AutoSize>Min, Min</AutoSize>                widget auto scale type, default is fixed.
...
#define LAYOUT_SCALE_TYPE_COUNT     5   // Fix, Width, Height, Min, Max
