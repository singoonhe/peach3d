...
void ObjSample::init(Widget* parentWidget)
{
    ...
    auto cubeNode = SceneManager::getSingleton().getRootSceneNode()->createChild(Vector3(0.f, 5.f, 0.f));
    ...
    auto cubeNode1 = SceneManager::getSingleton().getRootSceneNode()->createChild(Vector3(-8.f, 5.f, 0.f));
    ...
    auto cubeNode2 = SceneManager::getSingleton().getRootSceneNode()->createChild(Vector3(8.f, 5.f, 0.f));
    ...
    auto texNode1 = SceneManager::getSingleton().getRootSceneNode()->createChild(Vector3(-8.f, -5.f, 0.f));
    ...
    auto texNode2 = SceneManager::getSingleton().getRootSceneNode()->createChild(Vector3(8.f, -5.f, 0.f));
...
void DrawModeSample::init(Widget* parentWidget)
{
    ...
    auto cubeMesh = ResourceManager::getSingleton().addMesh("Cube.obj");
    auto cubeNode = rottNode->createChild(Vector3(-10.f, 0.f, 0.f));
    cubeNode->attachMesh(cubeMesh);
    // rotate repeat
    cubeNode->runAction(Repeat::createForever(RotateBy3D::create(Vector3(0.0f, DEGREE_TO_RADIANS(360.0f), 0.0f), 5.0f)));
    ...
    // create 9 nodes
    for (auto i=0; i<9; i++) {
        auto cubeNodex = rottNode->createChild(Vector3((i % 3) * 5 - 2.f, (i / 3) * 5.f - 4.f, 0.f));
...
void OBBSample::init(Widget* parentWidget)
{
    ...
    auto cubeNode = rootNode->createChild(Vector3(-10.f, 0.f, 0.f));
    cubeNode->attachMesh(cubeMesh);
    // rotate repeat
    cubeNode->runAction(Repeat::createForever(RotateBy3D::create(Vector3(0.0f, DEGREE_TO_RADIANS(-360.0f), 0.0f), 5.0f)));
    ...
    // create 9 nodes
    for (auto i=0; i<9; i++) {
        auto cubeNodex = rootNode->createChild(Vector3((i % 3) * 5 - 1.f, (i / 3) * 5.f - 4.f, 0.f));
